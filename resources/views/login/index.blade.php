...
<div class="md:py-48 py-4 bg-secondary w-full">
<div class="text-center mt-1">
    ...
    <h2 class="text-4xl tracking-wide font-semibold logo">
       Sign In
    </h2>
...
<div class="flex justify-center my-2 mx-4 md:mx-0">
 <form class="form-sign inw-full max-w-xl bg-white rounded-lg shadow-md p-6" action="/login" method="post">
   @csrf
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full md:w-full px-3 mb-6">
         ...
         <input type="text" autofocus required value="{{old('email')}}" name="email" id="email" placeholder="Email" class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none peer border border-slate-400 @error('email')peer-invalid:visible border-red-700 @enderror">
         @error('email')
       ...
       <div class="w-full md:w-full px-3 mb-3 mt-2">
            <button class="appearance-none block w-full bg-primary hover:bg-buttonh transition duration-200 ease-in-out text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight  focus:outline-none focus:bg-white focus:border-gray-500 hover:text-primary">
            Sign in</button>
            {{-- <a href="/register" type="submit" class="appearance-none text-center block w-full mt-3 bg-blue-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-blue-500 focus:outline-none focus:bg-white focus:border-gray-500">
            Sign Up</a>
       </div>
