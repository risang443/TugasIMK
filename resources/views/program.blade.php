        ...
        <section class="rounded-t-[56px] bg-white relative py-8 -mt-12 z-20 animate fade delay-6">
            <div id="setaraSD" class="pb-16 pt-4">
                ...
                <div class="md:container md:m-auto m-2 text-hitam pt-4 font-medium">
                    ...
                    <p class="pb-2">Program setara SD di HS Al Khoir merupakan program pendidikan dasar yang berfokus pada pengembangan karakter anak, etika dan keterampilan. Nilai-nilai ke Islaman menjadi dasar pengembangan pendidikan karakter dan etika yang ingin dicapai dalam program setara SD.</p>
                    ...
                    <p>Kurikulum yang digunakan adalah kurikulum 2013 pendidikan kesetaraan yang disesuaikan dengan kebutuhan peserta didik dan karakteristik daerah. Adapun output yang diharapkan yaitu;
                        ...
                        <p>Keungulan lain program setara SD di HS Al Khoir yaitu adanya pendekatan homeschooling yang dilakukan melalui pendekatan psikologi dan akademik terarah. Pendekatan ini memberikan kesempatan pada anak untuk belajar melalui suasana homy dan nyaman seperti di rumah. Layanan di HS Al Khoir sangatlah personal disesuaikan dengan kebutuhan, bakat dan minat anak. Layanan ini juga memberikan kesempatan kepada orang tua untuk terlibat lebih banyak pada program pendidikan putra-putrinya. Selain itu, pendekatan ini juga digunakan untuk mengembangkan kreativitas, keaktifan dan kemandirian anak.</p>
        ...
        <section  class="rounded-t-[56px] bg-secondary relative py-8 -mt-12 z-20" data-aos="fade-up">
            <div id="eksklusif" class="pb-16 pt-4">
                ...
                <div class="md:container md:m-auto m-2 text-hitam pt-4 font-medium">
                    ...
                    <p class="pb-2">Program ini terbuka untuk seluruh jenjang dari siswa SD, SMP, SMA, dan Cambridge Internasional Examination (CIE). Program ini terbuka baik peserta didik Al Khoir maupun peserta didik di luar Al Khoir yang membutuhkan pendampingan mendalam mengenai mata pelajaran yang kurang dapat dikuasai. </p>
